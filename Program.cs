...
class Estacionamiento
{
    public static void Main(string[] args)
    {
        ...
        do
        {
            ...
            do
            {
                ...
                switch (Tipovehi)
                {
                    ...
                    case 2:
                        ...
                        static void InicializarEspacios2(char[] espacios2)
                        {
                    ...
                    case 3:
                        ...
                        static void InicializarEspacios3(char[] espacios3)
                        {
                            for (int i = 0; i < espacios3.Length; i++)
                            {
                                espacios3[i] = '*';
                            }
                        }
                        ...
                        static void Ingresarmoto(char[] espacios3)
                        {
            ...
            Console.WriteLine("------------------------------------------------------------------------------------------");
            Console.WriteLine("presione cualquier tecla para volver a las tarifas O presione [0] para terminar el proceso");
            Console.WriteLine("------------------------------------------------------------------------------------------");
            Console.ReadKey();
            Console.Clear();
